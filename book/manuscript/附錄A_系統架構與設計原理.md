...
---
[← 返回正文：05 舊帳遷移備份與維護](./05_舊帳遷移備份與維護.md) ｜ [下一篇：附錄B 分帳核心演算法與原始碼解析 →](./附錄B_分帳演算法與原始碼解析.md)
---

> **本篇說明**：本系統核心原始碼已開源發布於 [GitHub 專案](https://github.com/bill86854238/shared-expense-book)。本附錄專為對系統底層架構、軟體工程設計或有客製化二次開發需求的專業讀者編寫。若您僅需日常使用，可略過此部分。
...
[← 返回正文：05 舊帳遷移、備份與日常維護](./05_migration-and-maintenance.md) ｜ [下一篇：附錄B 分帳核心演算法與原始碼解析 →](./appendix-b-algorithms-and-code.md)
