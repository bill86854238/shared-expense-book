...
需要基本的 Google Apps Script 知識：

1. 建立 Google 試算表
2. 複製 Code.gs, index.html, nameSelector.html 到 Apps Script
3. 啟用 People API
4. 部署為網頁應用程式
5. 初始化並設定白名單

> 📖 **需要詳細教學？**
> 查看 [FAQ.md](./FAQ.md)（38 個常見問題） 或 [購買部署助手工具包](https://billions65.gumroad.com/l/kwvhy)（5 分鐘互動式引導）
...
**$3 USD** 包含：
- ⭐ **互動式部署助手** - 4 步驟引導，不用看文檔
- ⭐ **白名單產生器** - 自動生成設定代碼
- ⭐ **主題配色教學** - 自訂介面顏色
- ⭐ **自訂分類教學** - 修改分類設定
- ⭐ **30 天 Email 技術支援**

**早鳥優惠**：前 50 份 $3 USD，之後 $5 USD

[立即購買 Gumroad →](https://billions65.gumroad.com/l/kwvhy)

---

> 💡 **開源 + 付費模式**：核心代碼完全開源免費，付費版提供部署工具和技術支援
> ❓ **常見問題？** 查看 [FAQ.md](./FAQ.md)
